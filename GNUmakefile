...
#QEMUOPTS = -drive file=$(OBJDIR)/kern/kernel.img,index=0,media=disk,format=raw -chardev file,id=seriallog,path=/home/plafer/LOGGINGTHESHIT -serial chardev:seriallog
