...
trap_init(void)
{
	...
	SETGATE(idt[7], 0, GD_KT, trapentries[7], 0);
	SETGATE(idt[8], 0, GD_KT, trapentries[8], 0);
	/* idt[9] isn't generated by recent processors*/
	SETGATE(idt[10], 0, GD_KT, trapentries[10], 0);
	SETGATE(idt[11], 0, GD_KT, trapentries[11], 0);
	SETGATE(idt[12], 0, GD_KT, trapentries[12], 0);
	SETGATE(idt[13], 0, GD_KT, trapentries[13], 0);
	SETGATE(idt[14], 0, GD_KT, trapentries[14], 0);
	/* idt[15] is reserved by intel */
	SETGATE(idt[16], 0, GD_KT, trapentries[16], 0);
	SETGATE(idt[17], 0, GD_KT, trapentries[17], 0);
...
trap_init_percpu(void)
{
	...
	thiscpu->cpu_ts.ts_esp0 = KSTACKTOPCPU(cpunum());
...
trap(struct Trapframe *tf)
{
	...
	if ((tf->tf_cs & 3) == 3) {
		...
		// serious kernel work.
		// We don't acquire if already in kernel mode because it means
